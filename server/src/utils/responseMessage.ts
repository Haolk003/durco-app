export const authError = {
  ...
  ERR_7: "INVALID LINK!",
  ERR_8: "YOUR ACCOUNT HAS NOT YET VERIFiED EMAIL",
  ERR_9: "RESET PASSWORD FAILED",
};
export const authSuc = {
  ...
  SUC_7: "GET PROFILE USER SUCCESSFULLY",
};
export const productSuc = {
  ...
  SUC_6: "PRODUCT FILTERED SUCCESSFULLY",
};
...
export const colorSucc = {
  SUC_1: "COLOR SUCCESSFULLY CREATED",
  SUC_2: "GET ALL COLOR SUCCESSFULLY",
  SUC_3: "GET COLOR BY ID SUCCESSFULLY",
  SUC_4: " COLOR BY ID SUCCESSFULLY UPDATED",
  SUC_5: "COLOR BY ID SUCCESSFULLY DELETED",
};
export const colorErr = {
  ERR_1: "CREATE COLOR FAILED",
  ERR_2: "GET ALL COLOR FAILED",
  ERR_3: "GET COLOR BY ID FAILED",
  ERR_4: "UPDATE COLOR BY ID FAILTED",
  ERR_5: "DELETE COLOR BY ID FAILTED",
  ERR_6: "COLOR NOT FOUND",
};
