...
var createProduct = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, productModel_1.default.create(data)];
            case 1:
                product = _a.sent();
...
var updateProductById = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, productModel_1.default.findById(id)];
            case 2:
                findProduct = _a.sent();
                if (!findProduct) {
                    throw (0, createError_1.default)(500, responseMessage_1.productErr.ERR_1);
                }
                return [4 /*yield*/, productModel_1.default.findByIdAndUpdate(id, data, {
                        new: true,
                    })];
            case 3:
...
var deleteProductById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, productModel_1.default.findByIdAndDelete(id)];
            case 3:
                product = _a.sent();
                return [2 /*return*/];
        }
