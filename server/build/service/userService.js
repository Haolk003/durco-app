...
var createUser = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userModel_1.default.create(data)];
            case 1:
                newUser = _a.sent();
...
var getUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, userModel_1.default.findById(id).populate("category brand")];
            case 2:
                findUser = _a.sent();
                if (!findUser) {
                    throw (0, createError_1.default)(400, responseMessage_1.userErr.ERR_3);
                }
                return [2 /*return*/, findUser];
        }
    });
}); };
var updateUserById = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    var updateUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, validateId_1.default)(id)];
            ...
            case 2:
                updateUser = _a.sent();
                if (!updateUser) {
                    throw (0, createError_1.default)(400, responseMessage_1.userErr.ERR_4);
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                deleteUser = _a.sent();
                if (!deleteUser) {
                    throw (0, createError_1.default)(400, responseMessage_1.userErr.ERR_5);
                }
